...
// //objects
// const warrior = new Character("warrior", 60, 40, "yellow");
// const goblin = new Character("goblin", 20, 15, "green");
// const averageJoe = new Character("average Joe", 35, 35, "pink");
// const villager = new Character("villager", 35, 35, "blue");
...
// //arrays
// const merchantComments = ["hey", "pssst...", "come over here"];

// //checkers
// let badGuyMet = false;
// let redeployOptions = true;
...
// const checkIfNear = (objs, i) => {
//   if (
//     objs[i].offsetTop > character.offsetTop - 30 &&
//     objs[i].offsetTop < character.offsetTop + 30 &&
//     objs[i].offsetLeft > character.offsetLeft - 30 &&
//     objs[i].offsetLeft < character.offsetLeft + 30
//   ) {
//     return true;
//   } else {
...
// setInterval(function () {
//   const merchantSays = merchantComments[randomIndex(merchantComments)];
